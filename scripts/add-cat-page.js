...
const categoriesContent = `<div id="categories-content" style="display: none;">
          <div class="card">
...
content = content.replace(searchStr, categoriesContent);
fs.writeFileSync(adminPath, content, 'utf8');
console.log('Categories page added');
